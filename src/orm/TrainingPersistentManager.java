...
public class TrainingPersistentManager extends PersistentManager {
	private static final String PROJECT_NAME = "Training";
	...
	private TrainingPersistentManager() throws PersistentException {
	...
	public static synchronized final PersistentManager instance() throws PersistentException {
		if (_instance == null) {
			_instance = new TrainingPersistentManager();
		}
