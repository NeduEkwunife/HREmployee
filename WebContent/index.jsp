...
<%@ page
	import="com.acn.training.utilities.UserCredential, com.acn.training.model.Role"%>
...
<body onload='document.f.j_username.focus();'
	style="background-image: url('images/home1.jpg'); background-repeat: repeat;">
	...
	<table align="right" style="border: none;" cellspacing="0"
		cellpadding="0">
					...
					<form name='f' action="j_spring_security_check" method='POST'>
						...
						<table>
							...
							<tr>
								...
								<td style="width: 105px;"><input class="button"
									name="submit" type="submit" value="Login"> <input
									class="button" name="reset" type="reset" /></td>
