...
<div align="right"><a href="logout" id="logout"><p class="auto-style6">Logout</p>
	</a></div>
<div class="auto-style7">
<div align="center" id="menu">
<ul class="auto-style3" style="width: 514px">

<li><a href="EditUser" class="edit"><p class="auto-style8">EDIT PROFILE</p></a>
<div class="auto-style8">
	&nbsp;&nbsp;</div>
	</li>
<li style="left: -1px; top: 0px; width: 171px"><a href="addskills.jsp" class="new">
<p class="auto-style8">ADD SKILLS</p></a>
	...
	<div align="left" id="hello">
		<h3 class="auto-style2" style="width: 815px">Hello  
	...
	<br><br><br>
	<iframe frameborder="0" name="Accenture in the news !" class="frame" color="#6B2400" width="1000" height="700"  align="right" src="http://rss.bloople.net/?url=https%3A%2F%2Fnews.google.co.uk%2Fnews%2Ffeeds%3Fpz%3D1%26cf%3Dall%26ned%3Duk%26hl%3Den%26q%3DAccenture%26output%3Drss&detail=200&limit=5&showtitle=false&striphtml=true&type=html">
	</iframe>
	...
	<% if(user.getPicture() != null) 
	{
	 ...
	 %>
		...
		<table border="1" style="width: 300px; border:0px;background-color: #6B2400; height:300px; color:#FFFFCC;">
